...
<body onload="startTime()">
    ...
    <div class="lebonplan_div_01">
        <div class="lebonplan_div_02">
            ...
            <div class="btn_logout_reset_div">
                <div>
                    <a href="lebonplan_reset_password.php" class="btn_logout_reset_01">Réinitialiser votre mot de
                        passe</a>
                </div>
                <div>
                    <a href="lebonplan_logout.php" class="btn_logout_reset_01">Déconnexion de votre compte</a>
                </div>
                <div>
    ...
    <div class="post_lebonplan_div_main">
        ...
        <div class="post_lebonplan_div_01">
			...
			echo '<div class="post_lebonplan_div_02"> Titre de la vente : ' .$ligne['titre'] . '<br><br> ' . 'Catégorie : ' .$ligne['type'] . '<br><br> <img class="lebonplan_img_01" src="'.$ligne['photo'].'" /><br><br> ' .  'Description : ' . $ligne['description'] . '<br><br> ' . 'Prix de vente : ' . $ligne['prix'] . '<br><br> ' . 'Nom du vendeur : ' . $ligne['username'] . '<br><br> ' . 'Numéro du vendeur : ' . $ligne['phone_number']  . '</div>';
